<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("pricelevelperitemdetail", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
<div class="page-header">
    <h1>
        Create pricelevelperitemdetail
    </h1>
</div>

{{ content() }}

{{ form("pricelevelperitemdetail/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
