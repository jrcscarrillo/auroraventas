<div class="page-header">
    <h1>
        Search pricelevelperitemdetail
    </h1>
    <p>
        {{ link_to("pricelevelperitemdetail/new", "Create pricelevelperitemdetail") }}
    </p>
</div>

{{ content() }}

{{ form("pricelevelperitemdetail/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    <label for="fieldCustomprice" class="col-sm-2 control-label">CustomPrice</label>
    <div class="col-sm-10">
        {{ text_field("CustomPrice", "size" : 30, "class" : "form-control", "id" : "fieldCustomprice") }}
    </div>
</div>

<div class="form-group">
    <label for="fieldCustompricepercent" class="col-sm-2 control-label">CustomPricePercent</label>
    <div class="col-sm-10">
        {{ text_field("CustomPricePercent", "size" : 30, "class" : "form-control", "id" : "fieldCustompricepercent") }}
    </div>
</div>
