<div class="page-header">
    <h1>
        Search quickbooks_queue
    </h1>
    <p>
        {{ link_to("quickbooks_queue/new", "Create quickbooks_queue") }}
    </p>
</div>

{{ content() }}

{{ form("quickbooks_queue/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group">
    <label for="fieldQuickbooksQueueId" class="col-sm-2 control-label">Quickbooks Of Queue</label>
    <div class="col-sm-10">
        {{ text_field("quickbooks_queue_id", "type" : "numeric", "class" : "form-control", "id" : "fieldQuickbooksQueueId") }}
    </div>
</div>
