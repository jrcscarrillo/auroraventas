<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("bonificadetalle", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
<div class="page-header">
    <h1>
        Create bonificadetalle
    </h1>
</div>

{{ content() }}

{{ form("bonificadetalle/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ text_field("Rate", "type" : "numeric", "class" : "form-control", "id" : "fieldRate") }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ text_field("RatePercent", "type" : "numeric", "class" : "form-control", "id" : "fieldRatepercent") }}
    </div>
</div>
