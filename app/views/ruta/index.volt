...
{% block forma %}
    ...
    {{ content() }}
    <p>
        {{ link_to("route", "Atras", "class": "btn btn-primary") }}
    </p>
    <div class="body bg-blue">
    {% endblock %}
    {% block cabecera %}
        {{ form('ruta', 'id': 'routenewForm', 'class': 'sky-form') }}
    {% endblock %}
    {% block cuerpoforma %}
        <fieldset>
            <section>
        ...
        <footer>
            {{ submit_button('Nueva Ruta', 'class': 'btn btn-primary') }}
            <p class="help-block">Usted esta generando una nueva ruta.</p>
        </footer>
    </form>
</div>
{% endblock %}